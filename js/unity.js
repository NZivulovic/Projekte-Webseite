...
//--------------------------------------------------//
{
  ...
  function switchPreview(targetId) {
    ...
    if (vid != null) {
      ...
      newImg.style.border = "2px solid rgb(168, 187, 219)";
    }
    ...
    if (vid == null) {
      ...
      newestImg.style.border = "2px solid rgb(168, 187, 219)";
    }
  ...
  const vidSource = "../videos/unityProjekte/projekt1/Timeline 2.mp4";
  ...
  function resetVideo() {
    ...
    newVid.style.border = "2px solid rgb(168, 187, 219)";
  }
}
//--------------------------------------------------//
